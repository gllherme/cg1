...
Mesh* Cube::createUnitaryWithBorderInCenaryCenter(Vector* reflectivity, double shininness) {
    ...
    mesh->addVertex(new Vertex(new Vector(0, 0, 0)));
    mesh->addVertex(new Vertex(new Vector(0, 0, 1)));
    mesh->addVertex(new Vertex(new Vector(1, 0, 1)));
    mesh->addVertex(new Vertex(new Vector(1, 0, 0)));
    mesh->addVertex(
        new Vertex(
            new Vector(0, 1, 0)
        )
...
MeshWithTexture* Cube::createWithTexture(Vector* baseCenter, double edgeSize, Image* image, double shininness) {
    ...
    double halfEdge = edgeSize / 2.0;
    double baseX = (*baseCenter)[0];
    double baseY = (*baseCenter)[1];
    double baseZ = (*baseCenter)[2];

    mesh->addVertex(new Vertex(new Vector(baseX - halfEdge, baseY, baseZ - halfEdge))); // 0
    mesh->addVertex(new Vertex(new Vector(baseX - halfEdge, baseY, baseZ + halfEdge))); // 1
    mesh->addVertex(new Vertex(new Vector(baseX + halfEdge, baseY, baseZ + halfEdge))); // 2
    mesh->addVertex(new Vertex(new Vector(baseX + halfEdge, baseY, baseZ - halfEdge))); // 3
    mesh->addVertex(new Vertex(new Vector(baseX - halfEdge, baseY + edgeSize, baseZ - halfEdge))); // 4
    mesh->addVertex(new Vertex(new Vector(baseX - halfEdge, baseY + edgeSize, baseZ + halfEdge))); // 5
    mesh->addVertex(new Vertex(new Vector(baseX + halfEdge, baseY + edgeSize, baseZ + halfEdge))); // 6
    mesh->addVertex(new Vertex(new Vector(baseX + halfEdge, baseY + edgeSize, baseZ - halfEdge))); // 7
...
MeshWithTexture* Cube::createUnitaryWithBorderInCenaryCenterWithTexture(Image* texture, double shininness) {
    MeshWithTexture* mesh = new MeshWithTexture (texture, shininness);
    mesh->addVertex(
        new Vertex(
            new Vector(0, 0, 0)
        )
